...
ZINGX_INIT_VERSION = 1.0
ZINGX_INIT_SITE = $(BR2_EXTERNAL_ZINGX_PATH)/board/zingx
...
define ZINGX_INIT_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 0644 $(BR2_EXTERNAL_ZINGX_PATH)/board/zingx/rootfs_overlay/etc/profile.d/zingx.sh \
		$(TARGET_DIR)/etc/profile.d/zingx.sh
